...
public class ProductsEntity {
    ...
    @Basic
    @Column(name = "pro_description_seo")
    ...
    public boolean equals(Object o) {
        ...
        if (proCategoryId != that.proCategoryId) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + proCategoryId;
