...
public class PaymentsEntity {
    private long id;
    private Integer pTransactionId;
    ...
    public Integer getpTransactionId() {
        return pTransactionId;
    }

    public void setpTransactionId(Integer pTransactionId) {
    ...
    @Basic
    @Column(name = "p_vnp_response_code")
    ...
    @Basic
    @Column(name = "p_transaction_code")
    ...
    public boolean equals(Object o) {
        ...
        if (pTransactionId != null ? !pTransactionId.equals(that.pTransactionId) : that.pTransactionId != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (pTransactionId != null ? pTransactionId.hashCode() : 0);
